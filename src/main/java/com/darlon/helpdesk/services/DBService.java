...
public class DBService {
	...
	public void instanceDB() {
		Technique tech1 = new Technique(null, "Darlon", "111.111.111-11", "darlon@email.com", encoder.encode("123"));
		tech1.addProfile(Profile.ADMIN);

		Client cli1 = new Client(null, "Linus Torvalds", "222.222.222.22", "linus@email.com", encoder.encode("123"));
